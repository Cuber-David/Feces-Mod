...
public class AntiCheat{
    ...
    public static void annihilateEntity(Entityc entity, boolean override, boolean setNaN){
        ...
        if(entity instanceof Unit unit){
            if(KMod.antiCheat != null && override) KMod.antiCheat.removeUnit(unit);
            try{
                K.content.extend.util.ReflectUtils.setField(unit, ReflectUtils.findField(unit.getClass(), "added", true), false);
            }catch(Exception e){
                KMod.print(e);
            }
            if(setNaN){
        ...
        if(entity instanceof Building building){
            ...
            if(KMod.antiCheat != null && override) KMod.antiCheat.removeBuilding(building);
            if(setNaN){
