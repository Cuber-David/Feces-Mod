...
public class SpecialDeathEffects{
    ...
    public Sound deathSound = Sounds.explosion, primaryDeathSound = Sounds.none;
    ...
    public void disintegrateUnit(Unit u, float x1, float y1, float x2, float y2, float width, VaporizeBatch.VaporizeHandler handler){
        KMod.vaporBatch.discon = d -> d.scorchColor.set(disintegrateColor);
        KMod.vaporBatch.switchBatch(x1, y1, x2, y2, width, u::draw, handler);
    }
    ...
    public void deathUnit(Unit u, float x, float y, float rotation, Cons<Fragmentation.FragmentEntity> alt){
        ...
        FragmentationBatch batch = KMod.fragBatch;
