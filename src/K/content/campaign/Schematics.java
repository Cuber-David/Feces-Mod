...
public class Schematics implements Loadable{
    ...
    private void loadLoadouts(){
        Seq.with(K.content.campaign.loadouts.basiccore, K.content.campaign.loadouts.basioncore).each(s -> checkLoadout(s, false));
    }
    ...
    public @Nullable Schematic getDefaultLoadout(CoreBlock block){
        return K.content.campaign.loadouts.basiccore;
    }
