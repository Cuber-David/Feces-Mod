...
public class PowerPole extends PowerNode {
    ...
    public void drawPlace(int x, int y, int rotation, boolean valid) {
        ...
        Drawf.square(x * tilesize + offset, y * tilesize + offset, laserRange * tilesize, 0f);
    ...
    public class PowerPoleBuild extends PowerNodeBuild {
        ...
        public void drawConfigure() {
            super.drawConfigure();
            Drawf.square(x, y, laserRange * tilesize, 0f);
