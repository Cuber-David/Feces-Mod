...
public class AcceledBulletType extends BasicBulletType {
    ...
    public AcceledBulletType() {
        super();
    }

    public AcceledBulletType(float speed, float damage, String bulletSprite) {
        super(speed, damage, bulletSprite);
    }

    public AcceledBulletType(float speed, float damage) {
        this(speed, damage, "bullet");
    }

    public AcceledBulletType(float damage, String bulletSprite) {
