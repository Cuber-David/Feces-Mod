...
public class ShieldGenerator extends BaseTurret {
    ...
    public float shieldHealth = 5000f;
    public float recoverSpeed = 100f / 60f;
    ...
    public ShieldGenerator(String name) {
        ...
        consumePower(50);
        consumeItem(items.Rody_electron, 1);
        consumeLiquid(liquids.ionic_liquid,12/60f);
    ...
    public class ShieldGeneratorBuild extends BaseTurretBuild implements ControlBlock {
        ...
        private void drawShield() {
            ...
            Fill.circle(xStart, yStart, 5f * sin1);
            ...
            Fill.circle(xStart, yStart, 3f * sin2);
            Fill.circle(rightCenter.x, rightCenter.y, 9f * sin2);
            Fill.circle(leftCenter.x, leftCenter.y, 9f * sin2);
            Lines.stroke(9f * sin2);
            Lines.arc(backCenter.x, backCenter.y, 250, 70f / 360f, rotation - 35);
            float l = 15/16f;
            float lvx = (leftCenter.x - backCenter.x)*l;
            float lvy = (leftCenter.y - backCenter.y)*l;
            float rvx = (rightCenter.x - backCenter.x)*l;
            float rvy = (rightCenter.y - backCenter.y)*l;
            Lines.stroke(9f * sin2,team.color.a(0.5f));
            Lines.line(backCenter.x+lvx, backCenter.y+lvy,backCenter.x, backCenter.y);
            Lines.line(backCenter.x+rvx, backCenter.y+rvy,backCenter.x, backCenter.y);
            Draw.color(team.color, Color.white, Mathf.clamp(hit));
